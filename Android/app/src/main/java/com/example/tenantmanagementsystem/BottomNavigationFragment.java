...
public class BottomNavigationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BottomNavigationView = inflater.inflate(R.layout.fragment_bottom_navigation, container, false);

        android.support.design.widget.BottomNavigationView bottomNavigationView = (android.support.design.widget.BottomNavigationView) BottomNavigationView.findViewById(R.id.bottom_navigation);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_myaccount:
                        //Intent myAccount = new Intent(getContext(), MyAccountActivity.class);
